    ...
    if hook_config is not None:
        ...
        if EvalutationHook is not None:
            if trained_epoch % int(EvalutationHook.Interval) == 0:
                ...
                wandb.log(
                    {
                        "vehicle_AP": result_dict["OBJECT_TYPE_TYPE_VEHICLE_LEVEL_2/AP"],
                        "ped_AP": result_dict["OBJECT_TYPE_TYPE_PEDESTRIAN_LEVEL_2/AP"],
                        "cyclist_AP": result_dict["OBJECT_TYPE_TYPE_CYCLIST_LEVEL_2/AP"],
                        "mAP": (
                            (
                                result_dict["OBJECT_TYPE_TYPE_VEHICLE_LEVEL_2/AP"]
                                + result_dict["OBJECT_TYPE_TYPE_PEDESTRIAN_LEVEL_2/AP"]
                                + result_dict["OBJECT_TYPE_TYPE_CYCLIST_LEVEL_2/AP"]
                            )
                            / 3.0
                        ),
                        "epoch": trained_epoch,
