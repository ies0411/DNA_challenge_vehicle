...
# python val.py --cfg_file ./cfgs/custom_models/dsvt_deep_test.yaml --ckpt /mnt/nas-1/eslim/workspace/dna_vehicle/dsvt_deep_4/ckpt/checkpoint_epoch_24.pth --work_dir /mnt/nas-1/eslim/workspace/dna_vehicle/test/